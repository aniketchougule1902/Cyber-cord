...
import { Shield, Mail, Lock, User, ArrowRight, CheckCircle2, Eye, EyeOff } from 'lucide-react'
...
export default function SignupPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 dot-grid flex items-center justify-center px-4">
      <div className="fixed top-0 right-0 w-96 h-96 bg-violet-200/30 rounded-full blur-3xl pointer-events-none" />
      <div className="fixed bottom-0 left-0 w-96 h-96 bg-brand-200/20 rounded-full blur-3xl pointer-events-none" />
      ...
      <div className="w-full max-w-md relative z-10 animate-fade-in">
        ...
        <div className="card p-8 shadow-modal">
          <div className="mb-6">
            ...
            <p className="text-slate-500 text-sm mt-1">Get started with CyberCord for free</p>
          </div>
          ...
          {success ? (
            <div className="flex flex-col items-center gap-4 py-6">
              ...
              <div className="text-center">
                <p className="text-base font-semibold text-slate-900">Account created!</p>
